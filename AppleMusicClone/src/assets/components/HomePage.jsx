...
function HomePage() {
  return (
    <div className='h-auto w-full bg-black/10 p-10 flex flex-col overflow-y-scroll'>
        ...
        <div className="container flex">
            <div className="mt-4 m-3">
                ...
                <div className="stationCards h-60 w-50 bg-indigo-200 rounded-md flex flex-col justify-center items-center relative overflow-hidden">
                    <img src="/makima.jpg" alt="" className='top-0 left-0 h-full w-full object-cover z-0 rounded-t-md'/>
        ...
        <div className="recentlyPlayedPlaylist w-full h-60 bg-amber-100 m-2"></div>
        <div className="recentlyPlayedPlaylist w-full h-60 bg-amber-100 m-2"></div>
        <div className="recentlyPlayedPlaylist w-full h-60 bg-amber-100 m-2"></div>
